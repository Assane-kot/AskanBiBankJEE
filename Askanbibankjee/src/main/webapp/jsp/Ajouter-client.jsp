				...
				<p class="succes">Vous êtes connecté en tant que :
					...
					<div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">            
                            <a class="btn btn-success btn-sm" href="Ajouter-client.php">CREATION CLIENT </a>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">            
                            <a class="btn btn-success btn-sm" href="listeClient.jsp">LISTE CLIENT</a>  </a>
                    ...
                    <div class="aj-admin">
                       <div class="register-box">
                          <div class="card card-outline card-primary">
                            ...
                            <div class="card-body">
                               <p class="login-box-msg">Ajouter un Client</p>
                                        ...
                                        <input type="radio" name="typepiece" value="CIN">
                                         <label>CIN</label> 
                                         
                                             
                                       
        
                                        <input type="radio" name="typepiece" value="PASSPORT">
