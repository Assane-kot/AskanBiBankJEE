				...
				<p class="succes">Vous êtes connecté en tant que :
					...
					<div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">            
                            <a class="btn btn-success btn-sm" href="Ajouter-client.jsp">CREATION CLIENT </a>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">            
                            <a class="btn btn-success btn-sm" href="listeClient.php">LISTE CLIENT</a>  </a>
            
                        </div>
                        <div class="col-xl-3 col-md-6 mb-4">            
                            <a class="btn btn-success btn-sm" href="ajouterCompte.php">CREATION COMPTE</a>  </a>
            
                        </div>
                        <div class="col-xl-3 col-md-6 mb-4">            
                            <a class="btn btn-success btn-sm" href="listeCompte.php">LISTE COMPTE</a>  </a>
                       ...
                       <div class="row">
                        ...
                        <table  class="table table-striped" width="100"  action="${pageContext.request.contextPath}/ListeClient">
                                    <thead width="100%">
                                        <tr>
                                          <th>NOM </th>
                                           <th>PRENOM </th>
                                     ...
                                     <c:forEach var="clients" items="${clients }">
                                      <tr>
                                           ...
                                           <th><c:out value="${clients.nom }"/></th>
                                           <th><c:out value="${clients.prenom }"/></th>
                                           <th><c:out value="${clients.adresse }"/></th>
                                            <th><c:out value="${clients.tel }"/></th>
                                            <th><c:out value="${clients.nature }"/></th>
                                      
                                          
         
                                          <td> <button ><a href="">Voir</a>
                                           </button> <button> <a href="">Modifier</a> 
                                           </button> 
                                           <button name="delete"> <a href="">Supprimer</a></button></td>
                                     </tr>
                                       </c:forEach>   
                                     </tbody>
